<script lang="ts">
	...
	import { signIn } from '$lib/features/crowdpark/api';
...
<svelte:head><title>Sign In · CrowdPark</title></svelte:head>
...
>
	...
	<Card.Root class="w-full max-w-[420px] [--card-spacing:--spacing(6)]">
		<Card.Header>
			...
			<Card.Description>Sign in to your CrowdPark account</Card.Description>
		</Card.Header>
				...
				<Field.FieldGroup>
					...
					<Field.Field>
						<div class="flex items-center justify-between">
							...
							<Button variant="link" href="/forgot-password" class="h-auto p-0 text-xs">
								Forgot password?
							</Button>
						</div>
						<InputGroup.Root class="h-12">
	...
	<p class="mt-6 text-sm text-muted-foreground">
		...
		<Button variant="link" href="/register" class="h-auto p-0 text-sm font-semibold text-brand-strong">
			Create account
		</Button>
	</p>
